...
# Initialization
pygame.init()
screen = pygame.display.set_mode((SCREEN_SIZE))  # maga az ablak
...
def draw(people):
    ...
    text = font.render(
        "Active cases:" + str(_count_infected_people), True, (200, 200, 200)
    )
    ...
    pygame.draw.circle(screen, PERSON_COLOR_CLEAR, (750, 23), PERSON_AURA, 0)
    pygame.draw.circle(screen, PERSON_COLOR_INFECTED, (930, 23), PERSON_AURA, 0)
    pygame.draw.circle(screen, PERSON_COLOR_IMMUNE, (1120, 23), PERSON_AURA, 0)
    pygame.draw.circle(screen, PERSON_COLOR_CLEAR, (1250, 23), PERSON_AURA, 5)
